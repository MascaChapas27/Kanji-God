...
class Button : public sf::Drawable{
    ...
    public:
        // The constructor sets the texture for both the bottom and the top sprites
        Button(const sf::Texture &bottomTexture, const sf::Texture &topTexture);

        // Sets the texture for the bottom part of the button
        void setBottomTexture(const sf::Texture &texture);

        // Sets the texture for the top part of the button
        void setTopTexture(const sf::Texture &texture);
