...
/*
    I tried drawing strokes as sf::PrimitiveType::LineStrip but it was too thin so I googled how to
...
class DrawableStroke : public sf::Drawable {
    ...
    public:
        ...
        DrawableStroke(const sf::Vector2f point1, const sf::Vector2f point2, sf::Color color, float thickness);
