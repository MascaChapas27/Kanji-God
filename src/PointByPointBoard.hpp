...
class PointByPointBoard : public DrawingBoard {
    ...
    protected:
        // Current position of the mouse, used to show an extra vertex when drawing
        sf::Vector2f mousePosition;

    public:

        // The constructor just calls the parent class' constructor
        PointByPointBoard(const sf::Texture& texture);
